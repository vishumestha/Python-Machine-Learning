...
plyfile = PlyData.read("D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module4/Datasets/stanford_armadillo.ply")
...
def do_PCA(armadillo):
  ...
  #armadillo=preprocessing.scale(armadillo)
