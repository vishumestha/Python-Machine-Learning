...
def Plot3D_1(T, title, x, y,z,num_to_plot=40):
  # This method picks a bunch of random samples (images in your case)
  # to plot onto the chart:
  fig = plt.figure()
...
def Plot3D(T, title, x, y,z,num_to_plot=40):
  ...
  # It also plots the full scatter:
  ax.scatter(T[:,x],T[:,y],z,marker='.',alpha=0.7)
...
mat = scipy.io.loadmat('D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module4/Datasets/face_data.mat')
...
Plot2D(T, "2DPCA implimentation", 0, 1, num_to_plot=40)
Plot3D(T, "3dPCA implimentation", 0, 1,2, num_to_plot=40)
...
Plot2D(T, "2DIsomap implimentation", 0, 1, num_to_plot=40)
Plot3D(T, "3DIsomap implimentation", 0, 1,2, num_to_plot=40)
