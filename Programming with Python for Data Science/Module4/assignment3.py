...
# by now ;-)
df=pd.read_csv('D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module4/Datasets/kidney_disease.csv')
df=df.dropna(axis=0)
#
...
#df=df.drop(labels=['id', 'classification'],axis=1)#, 'rbc', 'pc', 'pcc', 'ba', 'htn', 'dm', 'cad', 'appet', 'pe', 'ane'],axis=1)
...
ax.set_ylabel('wc')
ax.set_zlabel('rc')
ax.scatter(df.bgr,df.wc,df.rc,c='r',marker='*')
