...
file=os.listdir('D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/free-spoken-digit-dataset-master/recordings')
file_jackson=[x for x in file if re.search('0_jackson',x)]
for x in file_jackson:
    path='D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/free-spoken-digit-dataset-master/free-spoken-digit-dataset-master/recordings/'+x
...
X_train=train[:,:slice_size]
y_train=train[:,slice_size:]
