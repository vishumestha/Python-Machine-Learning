...
#
# .. your code here ..
X=pd.read_csv("D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/College.csv",index_col=0)
...
#X_room_board=MaxAbsScaler().fit_transform(X_room_board).reshape(-1,1)
y_Accept=X[['Accept']]
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test=train_test_split(X_room_board,y_Accept,test_size=0.30,random_state=7)
...
# .. your code here ..
model.fit(X_train,y_train)
#pd.to_pickle(model,'test.pickle')
#model=pd.read_pickle('test.pickle')
score=model.score(X_test,y_test)
...
#
# .. your code here ..
X_room_board=X[['Room.Board','Enroll']]
#X_room_board=Normalizer().fit_transform(X_room_board).reshape(-1,1)
y_Accept=X[['Accept']]
#from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test=train_test_split(X_room_board,y_Accept,test_size=0.30,random_state=7)
