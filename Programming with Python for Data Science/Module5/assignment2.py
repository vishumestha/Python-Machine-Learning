...
#
# .. your code here ..
df=pd.read_csv("D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/CDR.csv")
...
# .. your code here ..
users1=users[0]
user1=df[df.In==users1]


# INFO: Plot all the call locations
user1.plot.scatter(x='TowerLon', y='TowerLat', c='gray', alpha=0.1, title='Call Locations')
#plt.scatter(x=user1.TowerLon, y=user1.TowerLat, c='gray', alpha=0.1)
...
#
# .. your code here ..
#user1=df[(df.In==users1 )& ((df.DOW=='sat') | (df.DOW=='sun'))]# df.DOW='sun']
user1=user1[(user1.In==users1 )& (user1.DOW=='Sat') | (user1.DOW=='Sun')]
...
#
# .. your code here ..
#user1=df["06:00:00" <df.CallTime> "22:00:00"]
#user1=user1[(user1.CallTime >"22:00:00")|(user1.CallTime<"06:00:00")]
user1=user1[(datetime.timedelta(hours=6)>user1.CallTime) | (user1.CallTime >datetime.timedelta(hours=22))]
...
showandtell()
  # TODO: Comment this line out when you're ready to proceed
