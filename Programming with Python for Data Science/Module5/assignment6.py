...
# .. your code here ..
import pandas as pd
face_df=pd.read_csv("D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/face_labels.csv",names=['face'])
face_labels=face_df['face']
