...
#
# .. your code here ..
df=pd.read_csv("D:/Data Science with Python/6.Programming with Python for Data Science/DAT210x-master/DAT210x-master/Module5/Datasets/life_expectancy.csv",sep='\t')
...
y_train=df[df.Year<1986].WhiteMale
...
X_train=df[df.Year<1986].Year.reshape(-1,1)
#X_train=X_train.reshape(-1, 1)
y_train=df[df.Year<1986].BlackFemale.reshape(-1,1)
#y_train=y_train.reshape(-1, 1)
model.fit(X_train,y_train)
